...
namespace WebApp.Infrastructure.Migrations
{
    ...
    [Migration("20251222150612_AddMessageAutoDeleteSetting")]
    partial class AddMessageAutoDeleteSetting
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApp.Core.Entities.ChatRoom", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WebApp.Core.Entities.ChatRoomMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebApp.Core.Entities.MessageAttachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebApp.Core.Entities.VideoConversionJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WebApp.Core.Entities.ChatRoom", b =>
                {
                    b.HasOne("WebApp.Core.Entities.User", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("WebApp.Core.Entities.ChatRoomMember", b =>
                {
                    b.HasOne("WebApp.Core.Entities.ChatRoom", "ChatRoom")
                        .WithMany("Members")
            ...
            modelBuilder.Entity("WebApp.Core.Entities.Message", b =>
                {
                    ...
                    b.HasOne("WebApp.Core.Entities.User", "Receiver")
                        .WithMany()
            ...
            modelBuilder.Entity("WebApp.Core.Entities.VideoConversionJob", b =>
                {
                    b.HasOne("WebApp.Core.Entities.FileMetadata", "File")
                        .WithMany()
